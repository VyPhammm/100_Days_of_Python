...
tomato_image = PhotoImage(file= r"D:\100_Days_of_Python\Day28_Pomodoro-GUI\tomato.png")
...
reset_button = Button(text="Reset", font= ("Arial", 10), highlightthickness= 0, command= reset)
